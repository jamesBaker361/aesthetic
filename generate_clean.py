...
def main(args):
    ...
    for block in block_list:
        ...
        run_regression(block,dim,y_column,regression_limit,sparse_embedding_dir,stats_dir+block,"fp16",2,10) #use sparse dir for now; in the future only use clip_dir
